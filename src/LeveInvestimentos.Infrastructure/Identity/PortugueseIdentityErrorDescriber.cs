...
public sealed class PortugueseIdentityErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string? userName)
    {
        return new IdentityError
        {
            ...
            Description = $"O login '{userName}' é inválido. Use apenas letras e dígitos."
        };
    }
    ...
    public override IdentityError DuplicateUserName(string userName)
    {
        return new IdentityError
        {
            ...
            Description = $"O login '{userName}' já está em uso."
        };
    }
    ...
    public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
    {
        return new IdentityError
        {
            ...
            Description = $"A senha deve usar pelo menos {uniqueChars} caracteres diferentes."
        };
    }
    ...
    public override IdentityError UserAlreadyInRole(string role)
    {
        return new IdentityError
        {
            ...
            Description = $"O usuário já pertence ao perfil '{role}'."
        };
    }
    ...
    public override IdentityError UserNotInRole(string role)
    {
        return new IdentityError
        {
            ...
            Description = $"O usuário não pertence ao perfil '{role}'."
        };
    }
}
