        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandlinePhone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    LandlinePhoneDigits = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    MobilePhone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    MobilePhoneDigits = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    ProfilePhotoPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskAssignments_AspNetUsers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskAssignments_AspNetUsers_SubordinateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_SubordinateId",
                table: "TaskAssignments",
